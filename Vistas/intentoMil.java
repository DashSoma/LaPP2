 ...
 * @author Chrisp
 */
public class intentoMil extends javax.swing.JDialog implements Vista<Proveedor>{
     ...
     */
    public intentoMil(java.awt.Frame parent, boolean modal, ArrayList<Proveedor> lista) {
        super(parent, modal);
        initComponents();
    ...
    public intentoMil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
...
//        Refresca la tabla
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(intentoMil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                intentoMil dialog = new intentoMil(new javax.swing.JFrame(), true);
