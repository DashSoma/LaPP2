 ...
 */
public class ColaboradorBuscaView extends javax.swing.JDialog {
     ...
     */
    public ColaboradorBuscaView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void tblProductosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductosMousePressed
        if (evt.getClickCount() == 2) {
            this.cedula = tblProductos.getValueAt(tblProductos.getSelectedRow(), 0).toString();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColaboradorBuscaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ColaboradorBuscaView dialog = new ColaboradorBuscaView(new javax.swing.JFrame(), true);
