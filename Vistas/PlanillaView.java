...
public class PlanillaView extends javax.swing.JDialog {
    ...
    /**
     * En este Botón se generará la planilla de los colaboradores, incluyendo
     * datos de los ArrayList asignados.
     *
     * @param evt
     */
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        // Validación para comprobar si el año de pago ya ha pasado
    ...
    /**
     * Calcula el total de incremento salarial (plus) asignado a un colaborador
     * basado en su cédula.
     *
     * @param cedula La cédula del colaborador.
     * @param salarioBase
     * @return El total de incremento salarial asignado al colaborador, o 0 si
     * no se encuentran pluses asignados.
     */
    public float getAsignarPlus(int cedula, float salarioBase) {
        float totalIncremento = 0;

        // Itera sobre la lista de PlusesColab para encontrar los pluses asignados al colaborador con la cédula dada
        for (PlusesColab plusesColab : listaPColab) {
            if (plusesColab.getCedula() == cedula) {
                String[] pluses = plusesColab.getNombresPluses().split(",");

                // Para cada nombre de plus, busca el correspondiente en listaPlusesGenerales y suma su incremento
        ...
        return totalIncremento; // Retorna el total de incrementos
    }

    /**
     * Busca y retorna el objeto PlusesColab correspondiente a la cédula dada.
     *
     * @param cedula La cédula del colaborador a buscar.
     * @return El objeto PlusesColab correspondiente a la cédula, o null si no
     * se encuentra.
     */
    ...
    /**
     * Filtra y muestra las planillas basadas en el año y mes proporcionado.
     *
     * @param evt
     */
    ...
    /**
     * Muestra la tabla de planillas con todos los registros disponibles en la
     * lista de planillas.
     */
    ...
    /**
     * Calcula y retorna el salario bruto de la planilla actual.
     *
    ...
    /**
     * Calcula y retorna la deducción por CCSS (Caja Costarricense de Seguro
     * Social) del salario bruto.
     *
     * @return La deducción por CCSS calculada.
     */
    public float calcularDeduccionCCSS() {
        float deduCCSS = (float) (0.10 * calcularSalarioBruto());
        planilla.setDeducCCSS(deduCCSS);  // 10% del salario bruto
        return planilla.getDeducCCSS();
    }

    /**
     * Calcula y retorna la deducción por BP (Banco Popular) del salario bruto.
     *
     * @return La deducción por BP calculada.
     */
    public float calcularDeduccionBP() {
        float deducBP = (float) (0.05 * calcularSalarioBruto());
        planilla.setDeducBP(deducBP); // 5% del salario bruto
        return planilla.getDeducBP();
    }

    /**
     * Calcula y retorna el salario neto de la planilla actual después de las
     * deducciones por CCSS y BP.
     *
