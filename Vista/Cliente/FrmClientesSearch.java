 ...
 * @author jprod
 */
public class FrmClientesSearch extends javax.swing.JDialog {
    
   private List<Cliente> ents;
    private Vista<Cliente> observer;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmClientesSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmClientesSearch dialog = new FrmClientesSearch(new javax.swing.JFrame(), true);
