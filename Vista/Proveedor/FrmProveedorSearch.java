 ...
 * @author dashs
 */
public class FrmProveedorSearch extends javax.swing.JDialog {
    List<Proveedor> ents;
    private Vista observer;
    private DefaultTableModel tableModel;
    TableRowSorter<TableModel> sorter; 

    public void setEnts(List<Proveedor> ents) {
        this.ents = ents;
        if (ents == null || tableModel == null) return;
        tableModel.setNumRows(0);
        
        ents.forEach(proveedor -> tableModel.addRow(
                new Object[]{
                    proveedor.getId(),
                    proveedor.getNombre(),
     ...
     */
    public FrmProveedorSearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        observer.show(ents.stream().filter(proveedor -> proveedor.getId().equals(id)).findFirst().orElse(null));
//        this.dispose();
    int selectedRow = tblCustomers.getSelectedRow();
    if (selectedRow == -1) return; // Si no hay una fila seleccionada, salir del método
    try {
        ...
        observer.showError("El ID seleccionado no es válido.");
    }
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProveedorSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProveedorSearch dialog = new FrmProveedorSearch(new javax.swing.JFrame(), true);
