 ...
 * @author Chrisp
 */
public class ProductosView1 extends javax.swing.JDialog implements Vista<Productos> {

    private ProductoControlador productosController;
    private Productos producto;
    private DefaultTableModel model;

    public ProductosView1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        productosController = new ProductoControlador(this);
...
//        otro.calcularTotalInventario(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductosView1.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ProductosView1 dialog = new ProductosView1(new javax.swing.JFrame(), true);
